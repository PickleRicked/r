...
BUILDFILE      = 'http://'#'https://picklericked.github.io/r/builds.txt'
...
WIZARDFILE     = 'http://'#'https://picklericked.github.io/r/builds.txt'
#########################################################
...
HEADERTYPE     = 'Text'
HEADERMESSAGE  = '[B]Pickle Tools[/B]'
