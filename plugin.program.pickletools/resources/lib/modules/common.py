...
COLOR1              = 'magenta'
COLOR2              = 'cyan'
THEME1              = '[COLOR '+COLOR1+'][I][B]([COLOR '+COLOR2+']Pickle[/COLOR])[/B][/I][/COLOR] [COLOR '+COLOR2+']%s[/COLOR]'
...
def TextBoxError(title, msg):
	...
	if "ERRORS" in title:
		...
		try:
			...
			GET_VERSION         =  xbmc.translatePath('special://home/addons/plugin.program.pickletools/addon.xml')
			...
			"\npickle Version - " + str(addon_version) + \
			"\n\n" + \
			"--------------------------------------------------------------------------------------------------------------------------------------------" \
			"\n\n" + msg
		except:
