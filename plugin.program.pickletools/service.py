...
ADDON_ID            = 'plugin.program.pickletools'
USERDATA            = xbmc.translatePath(os.path.join('special://home/userdata',''))
SOURCES             = xbmc.translatePath(os.path.join('special://home/userdata','sources.xml'))
ADDON               = xbmc.translatePath(os.path.join('special://home/addons/plugin.program.pickletools',''))
					...
					if newversion > vernumber:
						...
						if choice == 0: 
							if fresh =='false': # TRUE
								...
								dialog.ok('[COLOR lightskyblue]A WIPE is required for the update[/COLOR]','Select the [COLOR green]YES[/COLOR] option in the NEXT WINDOW to wipe now.','Select the [COLOR lightskyblue]NO[/COLOR] option in the NEXT WINDOW to update later.','[I][COLOR smokewhite]If you wish to update later you can do so in [/COLOR][COLOR ghostwhite]PickleRicked[/COLOR] [COLOR lightsteelblue]Tools[/COLOR][/I]')
								xbmc.executebuiltin( "Dialog.Close(busydialog)" )
								wipe.FRESHSTART()
								sys.exit(1)		
						else:
...
#			xbmc.executebuiltin( "Dialog.Close(busydialog)" )
#			dialog = xbmcgui.Dialog()
#			dialog.ok(ADDONTITLE, "Your cache has been successfully cleared.","Thank you for using Pickle Tools")							
#
...
#				xbmc.executebuiltin( "Dialog.Close(busydialog)" )
#				dialog = xbmcgui.Dialog()
#				dialog.ok(ADDONTITLE, "Your packages have been successfully purged.","Thank you for using Pickle Tools")							
#
...
#			xbmc.executebuiltin( "Dialog.Close(busydialog)" )
#			dialog = xbmcgui.Dialog()
#			dialog.ok(ADDONTITLE, "Your thumbnails have been successfully cleared.","Thank you for using Pickle Tools")							
#	
