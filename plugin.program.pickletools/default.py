...
ADDONTITLE          =  "[COLOR lime]PickleRicked [/COLOR] [COLOR white]Tools[/COLOR]"
ADDON_ID            =  xbmcaddon.Addon().getAddonInfo('id') #'plugin.program.pickletools'
...
PICKLE_SETTINGS   =  xbmc.translatePath('special://userdata/addon_data/' + ADDON_ID + '/settings.xml')
...
COMMUNITY_OTA	    =  xbmc.translatePath('special://userdata/pickle_community_ota.txt')
...
CONTACT             =  'If it breaks, Its your own damn fault '
...
DEFAULT_HEADERS     =  [["User-Agent","pickle-tools"]]
COLOR1              = 'lime'
COLOR2              = 'cyan'
THEME1              = '[COLOR '+COLOR1+'][I][B]([COLOR '+COLOR2+']PickleRicked[/COLOR])[/B][/I][/COLOR] [COLOR '+COLOR2+']%s[/COLOR]'
...
PICKLERICKED_BUILDS     = BASEURL + base64.b64decode(b'YnVpbGRzL3dpemFyZC54bWw=') + '|SPLIT|lime'
PICKLERICKED_BLUE_BUILDS= BASEURL + base64.b64decode(b'YnVpbGRzL2VjaG9fYmx1ZS93aXphcmQueG1s') + '|SPLIT|dodgerblue'
...
PICKLERICKEDICON        = xbmc.translatePath('special://home/addons/' + ADDON_ID + '/icon.png')
...
PICKLE_VERSION        =  os.path.join(USERDATA,'picklericked_build.txt')
...
if not os.path.isfile(PICKLE_SETTINGS):
	if not os.path.exists(ADDON_DATA):
		os.makedirs(ADDON_DATA)
	shutil.copyfile(DEFAULT_SETTINGS, PICKLE_SETTINGS)
...
def INDEX():
	...
	pleasecheck 	= 0
	BUILD_CHECK_ERROR   = 0
	CURRENT_BUILD = "[COLOR lime]ERROR[/COLOR]"
	CURRENT_VERSION_CODE = "[COLOR lime]ERROR[/COLOR]"
	LATEST_VERSION = "[COLOR lime]ERROR[/COLOR]"

	#######################################################################
	#		FIND PICKLE TOOLS VERSION
	#######################################################################
		...
		if pleasecheck == 1:
			...
			for newversion,fresh in match:
				...
				if CURRENT_VERSION < LATEST_VERSION:
					CURRENT_VERSION_CODE = '[COLOR lime]' + CURRENT_VERSION + '[/COLOR]'
				else:
					CURRENT_VERSION_CODE = '[COLOR lime]' + CURRENT_VERSION + '[/COLOR]'
	except:
		CURRENT_BUILD = "[COLOR lime]ERROR[/COLOR]"
	...
	#if pleasecheck == 1:
	#	Common.addItem("[COLOR lime]--------------------------[/COLOR]",BASEURL,79,DIVIDER_ICON,FANART,'')
	#	Common.addItem("[COLOR white]Pickle Tools Version:[/COLOR] [COLOR lime]" + str(PICKLERICKED_ver) + "[/COLOR]",'url',999,ICON,FANART,'')
	#	Common.addItem('[COLOR ghostwhite]CURRENT BUILD: [/COLOR][COLOR lime]' + CURRENT_BUILD + '[/COLOR]',BASEURL,4,BUILD_ICON,FANART,'')
	#	Common.addItem('[COLOR ghostwhite]YOUR VERSION: [/COLOR]' + CURRENT_VERSION_CODE + '',BASEURL,4,BUILD_ICON,FANART,'')
	#	Common.addItem('[COLOR ghostwhite]LATEST VERSION: [/COLOR][COLOR lime]' + LATEST_VERSION + '[/COLOR]',BASEURL,4,BUILD_ICON,FANART,'')
	#	try:
	...
	#		else:
	#			Common.addItem('[COLOR lime]' + CURRENT_BUILD.upper() + ' IS UP TO DATE![/COLOR]',BASEURL,4,UPDATE_ICON,FANART,'')
	#	except:
	#		Common.addItem('[COLOR ghostwhite]ERROR RETRIEVING INFORMATION[/COLOR]',BASEURL,4,UPDATE_ICON,FANART,'')
	Common.addItem("[COLOR white]KODI VERSION[/COLOR] [COLOR lime]" + str(kodi_details) + "[/COLOR]",'url',79,ICON,FANART,'')
	Common.addItem("[COLOR white]PICKLE TOOLS VERSION[/COLOR] [COLOR lime]" + str(addon_version) + "[/COLOR]",'url',79,ICON,FANART,'')
	Common.addItem("[COLOR lime]--------------------------[/COLOR]",BASEURL,79,DIVIDER_ICON,FANART,'')
	#Common.addItem('[COLOR ghostwhite]RUN THE PickleRicked SECURITY CHECK[/COLOR]',BASEURL,181,TOOLS_ICON,FANART,'')
	...
	Common.addItem('[COLOR ghostwhite]Pickle Tools SETTINGS[/COLOR]',BASEURL,9,SETTINGS_ICON,FANART,'')
	Common.addItem("[COLOR lime]--------------------------[/COLOR]",BASEURL,79,DIVIDER_ICON,FANART,'')
	...
	Common.addItem('[COLOR ghostwhite]CONTACT: [COLOR lime]Kodi PickleRicked[/COLOR][/COLOR]',BASEURL,190,ICON,FANART,'')
	...
	#Common.addItem('[COLOR ghostwhite]VIEW Pickle Tools CREDITS[/COLOR]',BASEURL,81,SETTINGS_ICON,FANART,'')
	#Common.addItem("[COLOR lime]--------------------------[/COLOR]",BASEURL,79,DIVIDER_ICON,FANART,'')
...
def MAINTENANCE_MENU():
	...
	if check_log == "true":
		...
		if i == 0:
			ERRORS_IN_LOG = "[COLOR lime]0 Errors Found in Log[/COLOR]"
		elif i == 1:
			ERRORS_IN_LOG = "[COLOR red]" + str(i) + " Error Found in Log[/COLOR]"
		else:
			ERRORS_IN_LOG = "[COLOR red]" + str(i) + " Errors Found in Log[/COLOR]"

	Common.addDir('[COLOR lime]Press for System Overview[/COLOR]',BASEURL,163,SYSTEM_INFO_ICON,FANART,'')
	if check_folders == "true":
		try:
	...
	Common.addItem("[COLOR lime]----CLEANUP---------------[/COLOR]",BASEURL,79,DIVIDER_ICON,FANART,'')
	...
	Common.addItem("[COLOR lime]----AUTOCLEAN------------[/COLOR]",BASEURL,79,DIVIDER_ICON,FANART,'')
	Common.addItem('[COLOR white]Pickle Tools Settings[/COLOR]',BASEURL,9,SETTINGS_ICON,FANART,'')
	...
	Common.addItem("[COLOR lime]----LOGS------------------[/COLOR]",BASEURL,79,DIVIDER_ICON,FANART,'')
	if check_log == "true":
	...
	Common.addItem("[COLOR lime]----ADDONS----------------[/COLOR]",BASEURL,79,DIVIDER_ICON,FANART,'')
	...
	Common.addItem("[COLOR lime]----FIXES-----------------[/COLOR]",BASEURL,79,DIVIDER_ICON,FANART,'')
	...
	Common.addItem("[COLOR lime]----MISCELLANEOUS---------[/COLOR]",BASEURL,79,DIVIDER_ICON,FANART,'')
	...
	Common.addItem("[COLOR lime]----RESTORE KODI----------[/COLOR]",BASEURL,79,DIVIDER_ICON,FANART,'')
...
def BACKUPMENU():
	Common.addItem("[COLOR lime][B]----BACKUP MENU-----------[/B][/COLOR]",'url',22,DIVIDER_ICON,FANART,'')	
	...
	#Common.addItem("[COLOR lime][B]--------------------------[/B][/COLOR]",BASEURL,79,DIVIDER_ICON,FANART,'')
	Common.addItem("[COLOR lime][B]----RESTORE MENU----------[/B][/COLOR]",'url',22,DIVIDER_ICON,FANART,'')	
	...
	#Common.addItem("[COLOR lime][B]--------------------------[/B][/COLOR]",BASEURL,79,DIVIDER_ICON,FANART,'')
	Common.addItem("[COLOR lime][B]----OTHER MENU------------[/B][/COLOR]",'url',22,DIVIDER_ICON,FANART,'')	
...
def DEBRIDMENU():
	Common.addItem("[COLOR lime][B]----DEBRID MENU-----------[/B][/COLOR]",'url',22,DIVIDER_ICON,FANART,'')	
	#Common.addItem('[COLOR white]Full Backup (All Files and Folders Included)[/COLOR]','url',69,BACKUP_ICON,FANART,'')	
...
#######################################################################
def TRAKTMENU():
	Common.addItem("[COLOR lime][B]----TRAKT MENU-----------[/B][/COLOR]",'url',22,DIVIDER_ICON,FANART,'')	
...
def BUILDMENU():
	...
	LINKS = [PICKLERICKED_BUILDS,PICKLERICKED_BLUE_BUILDS]
	...
	for count,total,name,url,description,iconimage,fanart in tup:
		...
		#bname = " | [COLOR white] This Week:[/COLOR][COLOR lime][B] " + count + "[/B][/COLOR][COLOR white] - Total:[/COLOR][COLOR lime][B] " + total + "[/B][/COLOR]"
		bname = ""
		if COLOR_CODE == "dodgerblue":
			title = "[COLOR "+COLOR_CODE+"][B]" + name.upper() + " - BY PICKLERICKED BLUE[/B][/COLOR]" + bname
		else: title = "[COLOR "+COLOR_CODE+"][B]" + name.upper() + " - BY PICKLERICKED[/B][/COLOR]" + bname
...
def FANRIFFIC_THEMES():
	dp.create(ADDONTITLE, "[COLOR red][B]NOT CONNECTED![/B][/COLOR]", "[COLOR lime]Attempting to connect to Fanriffic server.[/COLOR]")
	...
	for url_list in urls:
		dp.update(0, "[COLOR lime][B]CONNECTED![/B][/COLOR]", "[COLOR lime]Getting themes from location " + str(j) + " of " + str(url_count) + "[/COLOR]")
...
def SPORT_LISTINGS():
	...
	for game,name1,name2,gametime in match:
		...
		Common.addItem('[COLOR lime][B]Watch on '+b+'[/B][/COLOR]','','',ICON,FANART,'')
...
def LATEST_LIST():
	if xbmc.getCondVisibility('system.platform.windows'):
		...
		Common.addItem('[COLOR white][B]Detected Platform: [/B][/COLOR][COLOR lime]' + platform_name + '[/COLOR]',url,999,ICON,FANART,'')
...
def LATEST_WINDOWS():
	if not xbmc.getCondVisibility('system.platform.windows'):
		dialog = xbmcgui.Dialog()
		dialog.ok(ADDONTITLE + " - Windows", "[B][COLOR white]Sorry, this function is only available for Windows devices[/COLOR][/B]",'[COLOR white]Thank you for using Pickle Tools[/COLOR]')
		sys.exit(1)
	else:
		link = Common.OPEN_URL(WINDOWS).replace('\n','').replace('\r','')
		match = re.compile('name="(.+?)".+?rl="(.+?)".+?mg="(.+?)".+?anart="(.+?)".+?ersion="(.+?)"').findall(link)
		Common.addItem('[COLOR lime][B]EXE Will Be Donwloaded to [COLOR lime]special://Downloads[/COLOR] You Will Need To Manually Install From There[/B][/COLOR]',BASEURL,79,APK_ICON,FANART,'')
...
def LATEST_OSX():
	if not xbmc.getCondVisibility('system.platform.osx'):
		dialog = xbmcgui.Dialog()
		dialog.ok(ADDONTITLE + " - OSX", "[B][COLOR white]Sorry, this function is only available for OSX devices[/COLOR][/B]",'[COLOR white]Thank you for using Pickle Tools[/COLOR]')
		sys.exit(1)
	else:
		link = Common.OPEN_URL(OSX).replace('\n','').replace('\r','')
		match = re.compile('name="(.+?)".+?rl="(.+?)".+?mg="(.+?)".+?anart="(.+?)".+?ersion="(.+?)"').findall(link)
		Common.addItem('[COLOR lime][B].dmg Will Be Donwloaded to [COLOR lime]special://Downloads[/COLOR] You Will Need To Manually Install From There[/B][/COLOR]',BASEURL,79,APK_ICON,FANART,'')
		Common.addItem('[COLOR white]-----------------------------------------------------------[/COLOR]',BASEURL,79,APK_ICON,FANART,'')
		for name,url,iconimage,fanart,description in match:
			Common.addItem(name,url,89,KODI_ICON,KODI_FANART,description)
...
def LATEST_IOS():
	if not xbmc.getCondVisibility('system.platform.ios'):
		dialog = xbmcgui.Dialog()
		dialog.ok(ADDONTITLE + " - iOS", "[B][COLOR white]Sorry, this function is only available for iOS devices[/COLOR][/B]",'[COLOR white]Thank you for using Pickle Tools[/COLOR]')
		sys.exit(1)
	else:
		link = Common.OPEN_URL(IOS).replace('\n','').replace('\r','')
		match = re.compile('name="(.+?)".+?rl="(.+?)".+?mg="(.+?)".+?anart="(.+?)".+?ersion="(.+?)"').findall(link)
		Common.addItem('[COLOR lime][B].deb Will Be Donwloaded to [COLOR lime]special://Downloads[/COLOR] You Will Need To Manually Install From There[/B][/COLOR]',BASEURL,79,APK_ICON,FANART,'')
		Common.addItem('[COLOR white]-----------------------------------------------------------[/COLOR]',BASEURL,79,APK_ICON,FANART,'')
		for name,url,iconimage,fanart,description in match:
			Common.addItem(name,url,89,KODI_ICON,KODI_FANART,description)
...
def LATEST_ANDROID():
	if not xbmc.getCondVisibility('system.platform.android'):
		dialog = xbmcgui.Dialog()
		dialog.ok(ADDONTITLE + " - Android", "[B][COLOR white]Sorry, this function is only available for Android devices[/COLOR][/B]",'[COLOR white]Thank you for using Pickle Tools[/COLOR]')
		sys.exit(1)
	else:
		link = Common.OPEN_URL(APKS).replace('\n','').replace('\r','')
		match = re.compile('name="(.+?)".+?rl="(.+?)".+?mg="(.+?)".+?anart="(.+?)".+?ersion="(.+?)"').findall(link)
		Common.addItem('[COLOR lime][B]APKS Will Be Donwloaded to [COLOR lime]/sdcard/Downloads[/COLOR] You Will Need To Manually Install From There[/B][/COLOR]',BASEURL,79,APK_ICON,FANART,'')
		Common.addItem('[COLOR white]-----------------------------------------------------------[/COLOR]',BASEURL,79,APK_ICON,FANART,'')
...
def INSTALLER_APKS():
	dialog = xbmcgui.Dialog()
	dialog.ok(ADDONTITLE, "This function is no longer supported in Pickle Tools")
	quit()
	#FOR ADDON INSTALLER
	if not xbmc.getCondVisibility('system.platform.android'):
		dialog.ok(ADDONTITLE + " - Android", "[B][COLOR white]Sorry, this function is only available for Android devices[/COLOR][/B]",'[COLOR white]Thank you for using Pickle Tools[/COLOR]')
		...
		for count,name,iconimage,fanart,url in tup:
			url2 = name + "#!" + url
			#bname = " | [COLOR white] This Week:[/COLOR][COLOR lime][B] " + count + "[/B][/COLOR]"
                        bname = ""
...
def DOWNLOADLIB():
	...
	match = re.compile('name="(.+?)".+?rl="(.+?)".+?mg="(.+?)".+?anart="(.+?)".+?ersion="(.+?)"').findall(link)
	Common.addItem('[COLOR lime][B]Lib Files Will Be Donwloaded to [COLOR lime]the Kodi special directory[/COLOR] You Will Need To Manually Install From There. The Windows Lib File will Auto Install[/B][/COLOR]',BASEURL,79,LIB_ICON,FANART,'')
...
def ANDROID_APKS():
	if not xbmc.getCondVisibility('system.platform.android'):
		...
		match = re.compile('name="(.+?)".+?rl="(.+?)".+?mg="(.+?)".+?anart="(.+?)"').findall(link)
		Common.addItem('[COLOR lime][B]APKS Will Be Donwloaded to [COLOR lime]/sdcard/Downloads[/COLOR][/B][/COLOR]',BASEURL,79,APK_ICON,FANART,'')
...
def VIEW_CHANGELOG():
	...
	Common.TextBox('[COLOR lime][B]Pickle Tools[/B][/COLOR]',msg)
...
def GET_SUPPORT():
	...
	Common.TextBox('[COLOR lime][B]Pickle Tools[/B][/COLOR]',f.text)
...
def REMOVE_KEYBOARD_FILE():
	try:
		...
		dialog.ok(ADDONTITLE, "[B][COLOR white]Sorry, Pickle Tools encountered an error[/COLOR][/B]",'[COLOR white]We were unable to remove the keyboard.xml file.[/COLOR]')
		sys.exit(0)
		
	dialog.ok(ADDONTITLE, "[B][COLOR white]Success, we have removed the keyboards.xml file.[/COLOR][/B]",'[COLOR white]Thank you for using Pickle Tools[/COLOR]')
...
def REMOVE_ADVANCED_FILE():
	try:
		...
		dialog.ok(ADDONTITLE, "[B][COLOR white]Sorry, Pickle Tools encountered an error[/COLOR][/B]",'[COLOR white]We were unable to remove the advancedsettings.xml file.[/COLOR]')
		sys.exit(0)
		
	dialog.ok(ADDONTITLE, "[B][COLOR white]Success, we have removed the advancedsettings.xml file.[/COLOR][/B]",'[COLOR white]Thank you for using Pickle Tools[/COLOR]')
	xbmc.executebuiltin("Container.Refresh")
...
def REPO_SOURCE_CHECKER():
	try:
		...
		for items in match:
			...
			name = "[COLOR lime][B]" + name + "[/B][/COLOR]"
...
def GET_KODIAPPS_RANKING():
	...
	for items in match:
		try:
			...
			Common.addItem("[COLOR lime][B]" + rank + "[/COLOR] - [COLOR white]" + name + "[/B][/COLOR]",url2,186,iconimage,KODIAPPS_FANART,"")
		except: pass
...
def GET_KODIAPPS_INFORMATION(name,url,iconimage):
	...
	choice = dialog.select("[COLOR lime][B]" + str(name) + " - Please Select an Option[/B][/COLOR]", ['[COLOR blue]View ' + str(name) + ' Information[/COLOR]','[COLOR blue]Add ' + str(name) + ' Source to File Manager[/COLOR]'])
	...
	if choice == 0:
		...
		for items in match:
				...
				heading = "[COLOR lime][B]" + heading + "[/B][/COLOR]"
		...
		Common.TextBox("[COLOR lime]Kodiapps Addon Information[/COLOR]",display)
	elif choice == 1:
		...
		if url_test in source_test:
			dialog.ok(ADDONTITLE, "[COLOR white]Name: [/COLOR][COLOR lime]" + str(name) + "[/COLOR]", "[COLOR white]Source: [/COLOR][COLOR lime]" + str(url2) + "[/COLOR]","[COLOR dodgerblue]Succesfully added to file manager.[/COLOR]")
		else:
			dialog.ok(ADDONTITLE, "[COLOR white]Name: [/COLOR][COLOR lime]" + str(name) + "[/COLOR]", "[COLOR white]Source: [/COLOR][COLOR lime]" + str(url2) + "[/COLOR]","[COLOR red]Was NOT added to the File Manager, please try again later.[/COLOR]")
	...
	try:
		...
		for item in match:
			...
			if "Not Found" not in result.content:
				...
				dp.update(100)
				dp.close
				dialog.ok(ADDONTITLE,"Pickle Tools was updated to " + str(new_version) + ', you may need to restart the addon for changes to take effect')
	except:
...
def GETTEMP():
	...
	dp.create(ADDONTITLE, "[COLOR lime][B]Connecting to the Pickle Tools API....[/B][/COLOR]")
	dp.update(0)
	...
	try:
		dp.update(25, '[COLOR lime][B]Connected![/B][/COLOR]','[COLOR white]Getting build information from the API.[/COLOR]')
		...
		dp.close()
		dialog.ok(ADDONTITLE, "We have successfully genenerated the PickleRicked download counters.")
		passed = 1
		quit()
	except: pass
...
def CLEARTEMP():
	dp.create(ADDONTITLE, "[COLOR lime]Removing Pickle Tools temp files.[/COLOR]")
	...
	if os.path.exists(TEMP_FOLDER):
		...
		try:
			...
			dp.close()
			dialog.ok(ADDONTITLE, "There was an error removing the PickleRicked temp files.")
			quit()
		dp.close()
		dialog.ok(ADDONTITLE, "We have succesfully removed the PickleRicked temp files.")
		quit()
...
def youtubefix():
	...
	if os.path.exists(YTDATA):
		try:
			...
			sys.exit(0)
		dialog.ok(ADDONTITLE,"[COLOR lime]Fixed!.[/COLOR]")
		xbmc.executebuiltin("Container.Refresh")
		sys.exit(0)
	else:
...
if mode==None:
        ...
        xbmc.executebuiltin("RunAddon(plugin.program.PICKLERICKEDtools)")
       ...
       community.CommunityUpdateNotice()
        ...
        dialog.ok(ADDONTITLE, '[COLOR lime][B]Current Time: [/B][/COLOR][COLOR white]' + THE_TIME + '[/COLOR]', '[COLOR lime][B]Current Date: [/B][/COLOR][COLOR white]' + THE_DATE + '[/COLOR]')
        ...
        time.sleep(5)
        dp.close()
        dialog.ok(ADDONTITLE, "All local addons have been updated. Thank you for using Pickle Tools!")
        sys.exit(0)
        ...
        maintenance.OPEN_SCRAPER_SETTINGS_SETTINGS()
